...
let titleUpdate = document.querySelector("title");
if (titleUpdate)
{
   titleUpdate.innerHTML = "Ranga bug Fix";
}
...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    //dynamically data show in this div
...
// this code will be run when click addToCart button
let count = 0;
...
//you get input form this function
